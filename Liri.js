...
//   function var(pa2,pa3){
//     if (pa2=="concert-this"){
//       //this is concert function
//       bands(pa3);
//     }
//     else if (pa2=="spotify-this-song"){
//       //this is find song function
//     }
//     else if (par2=="movie-this"){
//       //this is a movie function
//     }
//     else if (pa2=="do-what-it-says"){
...
//   var(pa2,pa3);
// function bands(pa3){
//   axios.get("https://rest.bandsintown.com/artists/"+pa3+"/events?app_id=codingbootcamp").then((response) => {

// for (var i=0; i<response.data.lenght; i++){
//   console.log(i);
//   console.log("nameOfTheVenue =  " +response.data[i].venue.name);
//   console.log("venueLocation = " + response.data[i].venue.city);
//   console.log("dateOfTheEvent = " +response.data[i].venue.datetime);
